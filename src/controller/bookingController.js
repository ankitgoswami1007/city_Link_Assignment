...
const createBooking = async (req, res) => {
    ...
    try {
        ...
        res.status(201).send({ status: true, message: "data Inserted Successfully", data: { bookingData: bookingSavedData, userData: userSavedData, vendorData: vendorSavedData } })
